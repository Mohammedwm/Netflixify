...
<html lang="en" dir="ltr">
    ...
    <!-- Navbar-->
        ...
        <script type="text/javascript" src="{{asset('dashboard_files/js/plugins/jquery.dataTables.min.js')}}"></script>
        <script type="text/javascript" src="{{asset('dashboard_files/js/plugins/dataTables.bootstrap.min.js')}}"></script>
