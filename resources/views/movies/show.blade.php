        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-white">
                    ...
                    <p>Views : <span id="movies__views">{{ $movie->views}}</span></p>

                    <p class="movie__description my-3">{{ $movie->description}}</p>
                    @auth
                        <a href="#" class="btn btn-primary text-capitalize my-3 movie__fav-btn">
        ...
        function PlayerjsEvents(event,id,data){
            ...
            if(percent  > 10 && !viewsCounted){
                $.ajax({
                    ...
                    method : 'POST',
                    success : function(){
                        let views = parseInt($('#movies__views').html());
                        $('#movies__views').html(views + 1);
                    },
                });
